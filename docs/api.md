...
| **Auth Token** | `__PC_AUTH_TOKEN_REDACTED__` |
| **认证模式** | `token` |
...
  "authToken": "__PC_AUTH_TOKEN_REDACTED__",
  "clientMode": "webchat",
  "protocolVersion": 1
}
```
...
AUTH_TOKEN=__PC_AUTH_TOKEN_REDACTED__
```
...
  static const String authToken = '__PC_AUTH_TOKEN_REDACTED__';
}
...
# 生成 QR 码
echo '{"g":"wss://devyn-physicochemical-halina.ngrok-free.dev","t":"__PC_AUTH_TOKEN_REDACTED__","m":"webchat"}' | qrencode -t ANSI -o -
```
...
    <string name="gateway_auth_token">__PC_AUTH_TOKEN_REDACTED__</string>
...
    public static final String AUTH_TOKEN = "__PC_AUTH_TOKEN_REDACTED__";
...
    static let authToken = "__PC_AUTH_TOKEN_REDACTED__"
...
   // ✅ 正确
   const ws = new WebSocket('wss://devyn-physicochemical-halina.ngrok-free.dev?auth_token=__PC_AUTH_TOKEN_REDACTED__');
   ```

2. 检查 Token 是否正确
   ```bash
   echo "你的 Token: __PC_AUTH_TOKEN_REDACTED__"
   ```
...
# 测试连接
wscat -c "wss://devyn-physicochemical-halina.ngrok-free.dev?auth_token=__PC_AUTH_TOKEN_REDACTED__"

# 发送测试消息
{"type":"connect","minProtocol":1,"maxProtocol":1,"client":{"id":"test-client","displayName":"Test","version":"1.0.0","platform":"test","mode":"webchat"},"auth":{"token":"__PC_AUTH_TOKEN_REDACTED__"}}
```
