...
server {
    listen 80;
    server_name 47.243.55.130;  # 修改为你的域名或 IP
...
# 设置 Secrets
gh secret set SERVER_HOST -b"47.243.55.130" -R your-username/TRIX_ap
...
3. 添加以下 3 个 Secrets:
   ...
   | Name | Value | 说明 |
   |-------|-------|------|
   | `SERVER_HOST` | `47.243.55.130` | 服务器 IP |
...
**提示词模板**:
```
我的项目已配置 GitHub Actions 自动部署到服务器 47.243.55.130。
请帮我：
1. 检查是否有未提交的代码
2. 提交并推送到 main 分支
3. 查看部署状态
