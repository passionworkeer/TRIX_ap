...
```bash
# 服务器日志
ssh root@47.243.55.130 "pm2 logs clawbot-channel"
...
3. 外网是否可访问: `curl http://47.243.55.130:8765/health`
...
```bash
# 查看数据库
ssh root@47.243.55.130 "sqlite3 /opt/clawbot-channel/data/pairing.db 'SELECT * FROM pairings ORDER BY created_at DESC LIMIT 5'"
