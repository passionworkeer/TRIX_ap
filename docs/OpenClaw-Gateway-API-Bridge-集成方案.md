...
- **端口**: 18789
- **认证模式**: Token
- **Token**: `3162c7078b7fa574271f483401729cac57f309cd2a507dd7`
...
// 或使用测试服务器: 'ws://47.243.55.130:8765'
...
```javascript
// relay-server.js (在 wss://m.jmtrick.com 或 47.243.55.130:8765 服务器上)
...
2. 确认 RELAY_SERVER_URL 配置正确（`wss://m.jmtrick.com` 或 `ws://47.243.55.130:8765`）
3. 检查本地网络是否正常
4. 检查防火墙是否阻止出站连接
