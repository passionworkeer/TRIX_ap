...
| 配置项 | 状态 | 值 |
|--------|------|------|
| **服务器 IP** | ✅ 配置完成 | `47.243.55.130` |
| **WebSocket 端口** | ✅ 运行中 | `8765` |
| **完整地址** | ✅ 可访问 | `ws://47.243.55.130:8765` |
...
**启动命令**：
```bash
ssh root@47.243.55.130 "python3 /root/cloud_server.py > /tmp/cloud_server.log 2>&1 &"
```
...
| **云端地址** | ✅ 已配置 | `ws://47.243.55.130:8765/nanobot/ws` (L18) |
...
| **云端地址** | ✅ 已配置 | `ws://47.243.55.130:8765` (L49) |
...
- [x] **云端服务器** - 已启动并运行在 `47.243.55.130:8765`
