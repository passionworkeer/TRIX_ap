...
```bash
ssh root@TRIX_SERVER_HOST "sqlite3 /opt/clawbot-channel/data/pairing.db 'SELECT id, pairing_code, device_id, user_id, status FROM pairings ORDER BY created_at DESC LIMIT 5'"
```
