...
# 手动部署指南 - 服务器端部署脚本
# ============================================================
# 请在服务器 TRIX_SERVER_HOST 上手动执行以下命令
...
if [ ! -f "relay_server_with_bridge.py" ]; then
    ...
    echo "scp e:\\desktop\\trix-3d-companion\\bridge\\relay_server_with_bridge.py root@TRIX_SERVER_HOST:/root/nanobot/"
    echo ""
    exit 1
fi
...
echo ""
echo "🔗 配置信息:"
echo "  WebSocket地址: ws://TRIX_SERVER_HOST:8765"
echo ""
echo "📱 下一步:"
