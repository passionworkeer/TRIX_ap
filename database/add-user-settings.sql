...
-- 添加注释
COMMENT ON TABLE user_settings IS '用户隐私设置表';
COMMENT ON COLUMN user_settings.allow_stranger_search IS '允许陌生人通过邮箱或用户名查找';
COMMENT ON COLUMN user_settings.show_online_status IS '显示在线状态';
COMMENT ON COLUMN user_settings.allow_study_invites IS '允许好友邀请自习';
