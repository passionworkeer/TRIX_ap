...
VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJxemp1bXhmemlraWtnanRzY2tqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mzg2NzE1OTIsImV4cCI6MjA1NDI0NzU5Mn0.4rZxl2QWpfZyPMpB7qJ7KHZj9WwWwzIYLQ5g4g4z1Yw
```

**错误示例**（不要使用）：
```env
VITE_SUPABASE_ANON_KEY=sb_publishable_HZ5YXVUyPAoNfD5x9Sz97Q_4JlBTANT  ❌ 错误格式！
```
