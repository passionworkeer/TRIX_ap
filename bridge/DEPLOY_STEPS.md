...
# 上传部署脚本
scp e:\desktop\trix-3d-companion\bridge\SERVER_DEPLOY_MANUAL.sh root@TRIX_SERVER_HOST:/root/nanobot/
```
...
```bash
ssh root@TRIX_SERVER_HOST "pm2 logs relay-server --lines 20"
```
...
现在你可以通过手机访问 **http://TRIX_SERVER_HOST** 来使用App了！
