...
```swift
// 不安全的开发环境配置
static let development = "http://TRIX_SERVER_HOST:8765"  // 第12行
static let development = "ws://TRIX_SERVER_HOST:8765"    // 第27行
```
...
```swift
// 建议修改为
static let development = "https://TRIX_SERVER_HOST:8765"
static let development = "wss://TRIX_SERVER_HOST:8765"
