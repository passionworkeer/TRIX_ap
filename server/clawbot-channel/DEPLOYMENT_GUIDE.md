...
```powershell
scp E:\desktop\trix-3d-companion\clawbot-channel.zip root@TRIX_SERVER_HOST:/opt/clawbot-channel/
```

**方法 B: 使用 WinSCP/FileZilla 等 SFTP 工具上传**

1. 连接到 TRIX_SERVER_HOST (root 用户)
...
# 3. 上传到服务器
scp E:\desktop\trix-3d-companion\clawbot-channel-update.zip root@TRIX_SERVER_HOST:/opt/clawbot-channel/
